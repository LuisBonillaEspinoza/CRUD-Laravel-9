...
Route::get('tarea/{tareas}/mostrar', [TareaController::class, 'show'])->name('tarea.show');
Route::delete('tarea/{tareas}/eliminar', [TareaController::class, 'destroy'])->name('tarea.destroy');
